...
```console
curl -Lo footloose https://github.com/weaveworks/footloose/releases/download/0.6.1/footloose-0.6.1-linux-x86_64
chmod +x footloose
...
```console
curl --silent --location https://github.com/weaveworks/footloose/releases/download/0.6.1/footloose-0.6.1-darwin-x86_64.tar.gz | tar xz
sudo mv footloose /usr/local/bin
```
